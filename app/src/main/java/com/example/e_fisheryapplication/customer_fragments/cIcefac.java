...
public class cIcefac extends Fragment {
    ...
    public static cIcefac newInstance() {
        cIcefac fragment = new cIcefac();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_c_icefac, container, false);
        rv=root.findViewById(R.id.cicerv);
